...
public class PagerInterceptor implements Interceptor {
	...
	try {
	    ...
	    Constructor<?> constructor = clazz.getConstructor(MappedStatement.class, Object.class,
		    PageBounds.class);
	...
	Boolean async = pageBounds.getAsyncTotalCount() == null ? asyncTotalCount : pageBounds
		.getAsyncTotalCount();
